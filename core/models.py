...
class DatosGenerales(Model):
    ...
    municipio = CharField(max_length=150, blank=True, null=True)
    comunidad = CharField(max_length=150, blank=True, null=True)
    elevacion = FloatField(blank=True, null=True, default=0)
